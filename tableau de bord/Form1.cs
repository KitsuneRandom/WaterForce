...
namespace tableau_de_bord
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            cx.Open();
            LoadMissions();
            btnquitter.Location = new Point(21, 900);
            grpmissions.Size = new System.Drawing.Size(1600, 950);
        }
        ...
        private void LoadMissions()
        {
            ...
            foreach (DataRow row in missionTable.Rows)
            {
                ...
                gb.Text = $"Mission {id}";
                gb.Size = new System.Drawing.Size(grpmissions.Width - 20, terminee ? 260 : 230); // GroupBox plus grand
                gb.Tag = terminee;
